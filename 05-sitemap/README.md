...
## Exercise details
[](https://github.com/gophercises/sitemap#exercise-details)
...
### Notes
[](https://github.com/gophercises/sitemap#notes)
**1. Be aware that links can be cyclical.**

That is, page `abc.com` may link to `abc.com/about`, and then the about page may link back to the home page (`abc.com`). These cycles can also occur over many pages, for instance you might have:
...
## Bonus
[](https://github.com/gophercises/sitemap#bonus)
