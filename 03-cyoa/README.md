...
## Exercise details
[](https://github.com/gophercises/cyoa#exercise-details)
...
*See [gopher.json](https://github.com/gophercises/cyoa/blob/master/gopher.json) for a real example of a JSON story. I find that seeing the real JSON file really helps answer any confusion or questions you might have about the JSON format.*
...
- Matt Holt's JSON-to-Go is a really handy tool when working with JSON in Go! Check it out - [https://mholt.github.io/json-to-go/](https://mholt.github.io/json-to-go/)

## Bonus
[](https://github.com/gophercises/cyoa#bonus)
