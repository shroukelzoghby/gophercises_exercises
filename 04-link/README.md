...
## Exercise details
[](https://github.com/gophercises/link#exercise-details)
...
### Notes
[](https://github.com/gophercises/link#notes)
...
I created a few simpler HTML files and included them in this repo to help with testing. They won't cover all potential use cases, but should help you start testing out the code.
...
## External Resources
[](https://github.com/gophercises/link#external-resources)
In the solution for this exercise I end up using a DFS, which is a graph theory algorithm. If you want to learn a little more about that, I have discussed this on YouTube here - [https://www.youtube.com/watch?v=zboCGDMnU3I](https://www.youtube.com/watch?v=zboCGDMnU3I)
...
## Bonus
[](https://github.com/gophercises/link#bonus)
